...
**[Node3(Client)  ens36] ----11.11.11.0/24----> [ens36 Node2(FsmXLB) ens33] ----12.12.12.0/24----> [ens33 Node1(k3s)]**

### 1.1 Node1(k3s)

```bash
sudo ip a add 12.12.12.254/24 dev ens33
```

### 1.2 Node2(FsmXLB)

```bash
sudo ip a add 12.12.12.253/24 dev ens33
sudo ip a add 11.11.11.253/24 dev ens36
```

### 1.3 Node3(Client)

```bash
sudo ip a add 11.11.11.254/24 dev ens36
```

### 1.4 Node2(FsmXLB)

```bash
ping -c 3 12.12.12.254
ping -c 3 11.11.11.254
```
