...
osm install \
    ...
    --set=osm.localDNSProxy.primaryUpstreamDNSServerIPAddr=8.8.8.8 \
    --set=osm.localDNSProxy.secondaryUpstreamDNSServerIPAddr=114.114.114.114 \
    --timeout=900s
...
kubectl apply -n httpbin -f https://raw.githubusercontent.com/cybwan/osm-edge-start-demo/main/demo/egress/httpbin.yaml
